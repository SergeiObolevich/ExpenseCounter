...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String DB_DEBTOR_TABLE = "deptors";
    public static final String COLUMN_DEBTOR_ID = "_id";
    public static final String COLUMN_DEBTOR_MONEY = "money";
    public static final String COLUMN_DEBTOR_NAME = "name";
    public static final String COLUMN_DEBTOR_CHOOSE = "choise";

    private static final String DB_CREATE_DEPTORS =
            "create table " + DB_DEBTOR_TABLE + "(" +
                    COLUMN_DEBTOR_ID + " integer primary key autoincrement, " +
                    COLUMN_DEBTOR_NAME + " text, " +
                    COLUMN_DEBTOR_MONEY + " real, " +
                    COLUMN_DEBTOR_CHOOSE + " text" + ");";
