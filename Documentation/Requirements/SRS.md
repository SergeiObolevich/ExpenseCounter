...
1. Приложение должно работать стабильно, с количеством отказов не более 5%.
2. Приложение должно восстанавливаться при возникновении сбоев, т.е. оно должно восстанавливать данные и работоспособность.
 ...
 ### 4. Аналоги <a name="4"></a>
  ...
  Обладает похожим на Monefy функционалом, однако выполнено в более простом графическом стиле и имеет другую организацию навигации.		
  
Разрабатываемое приложение обладает похожим функционалом, но отличается простым и менее красочным интерфейсом, а главным отличием является отсутствие рекламы.